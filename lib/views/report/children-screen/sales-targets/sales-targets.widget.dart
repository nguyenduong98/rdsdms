...
import 'package:rdsdms/views/report/children-screen/sales-targets/dialog.widget.dart';

class SalesTargets extends StatefulWidget {
  SalesTargets({Key key}) : super(key: key);

  @override
  createState() => SalesTargetsState();
}

class SalesTargetsState extends State<SalesTargets> {
      ...
      children: [
        ...
        Expanded(
          ...
          child: Container(
            ...
            alignment: Alignment.center,
            child:
                Text('Chỉ tiêu', style: TextStyle(fontWeight: FontWeight.w800)),
          ),
        ),
        Expanded(
          flex: 3,
